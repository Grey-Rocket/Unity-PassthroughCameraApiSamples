...
{
    public class MirroredAssessmentManagerV2 : MonoBehaviour
    {
        [Tooltip("Assign the PassthroughCameraAccess component configured for the RIGHT camera. Both eyes will display this feed.")]
        ...
        private IEnumerator Start()
        {
            ...
            while (!m_rightCameraAccess.IsPlaying)
                yield return null;
            ...
            m_mirrorMaterial.SetTexture("_MainTex", m_rightCameraAccess.GetTexture());
